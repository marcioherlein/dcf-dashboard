...
export function ETFOnboardBanner() {
  ...
  return (
    <div className="relative glass-card-light rounded-xl border border-[#BFD2A1] bg-olive-50/60 p-4 pr-10">
      <p className="text-sm font-semibold text-[#06101F] mb-1">How the Value Score works</p>
      <p className="text-sm text-[#566174] leading-relaxed">
      ...
      <button
        onClick={dismiss}
        aria-label="Dismiss"
        className="absolute top-3 right-3 min-w-[44px] min-h-[44px] flex items-center justify-center rounded-lg text-[#8A95A6] hover:text-[#566174] hover:bg-[#F4F3EF] transition-colors focus-visible:ring-2 focus-visible:ring-olive-700 focus-visible:outline-none"
      >
        <X size={14} />
      </button>
    </div>
