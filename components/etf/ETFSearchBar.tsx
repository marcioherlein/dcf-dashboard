    ...
    <div ref={containerRef} className="relative w-full max-w-xl">
      <div className="relative flex items-center">
        ...
        <input
          ...
          className="w-full pl-10 pr-10 py-3 rounded-xl border border-slate-200 bg-white text-[16px] text-slate-800 placeholder:text-slate-400 shadow-sm focus:outline-none focus:ring-2 focus:ring-olive-700 focus:border-transparent transition-all"
        />
        {query && (
          <button
