...
export function InsicLogo({
  ...
  if (variant === "mark") {
    return (
      <svg className={className} width="124" height="160" viewBox="0 0 124 160" fill="none" xmlns="http://www.w3.org/2000/svg" role="img" aria-label={title}>
        <title>{title}</title>
  ...
  if (variant === "wordmark") {
    return (
      <svg className={className} width="230" height="100" viewBox="0 0 230 100" fill="none" xmlns="http://www.w3.org/2000/svg" role="img" aria-label={title}>
        <title>{title}</title>
  ...
  return (
    <svg className={className} width="340" height="120" viewBox="0 0 340 120" fill="none" xmlns="http://www.w3.org/2000/svg" role="img" aria-label={title}>
      <title>{title}</title>
