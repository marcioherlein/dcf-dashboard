  ...
  return (
    <div className="rounded-xl glass-card-light overflow-hidden">
      <div className="px-4 py-2.5 border-b border-slate-200 flex items-center gap-2">
        ...
        <span className="text-[11px] font-bold text-slate-500 uppercase tracking-wider">Earnings Calendar</span>
                ...
                >
                  ...
                  {e.epsEstimate != null && (
                    <div className="text-right shrink-0">
                      ...
                      <p className="text-[11px] font-mono font-semibold text-slate-700">{fmtEPS(e.epsEstimate)}</p>
                    </div>
                  )}
                </Link>
              ))}
