  ...
  return (
    <section style={{ background: 'white', borderBottom: '1px solid #E2E8F0' }}>
      <div className="mx-auto max-w-[1200px] px-6 py-24">
        <div
          className="rounded-[24px] text-center px-8 py-14"
          style={{
        ...
        >
          ...
          <p style={{ fontSize: '17px', color: '#64748B', lineHeight: 1.55, marginBottom: '32px' }}>
            Type any ticker. See fair value, implied growth, and a verdict — in seconds.
          </p>

          {/* Search */}
          <div ref={containerRef} className="relative mx-auto" style={{ maxWidth: '480px' }}>
            <div
              ...
              >
                {results.map(r => (
                  <button
                    ...
                    className="flex w-full items-center gap-3 px-4 py-3 hover:bg-slate-50 border-b border-slate-100 last:border-b-0 transition-colors"
                  >
