    ...
    >
      ...
      <div className="flex items-start justify-between gap-2">
        ...
        <button
          ...
          className="lg:opacity-0 lg:group-hover:opacity-100 text-[#6B6A72] hover:text-[#cf222e] transition-all p-1 rounded hover:bg-[#FEE2E2] min-w-[44px] min-h-[44px] flex items-center justify-center"
        >
