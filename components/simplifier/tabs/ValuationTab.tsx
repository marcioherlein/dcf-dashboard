      ...
      <div className="rounded-xl border border-[#E8E6E0] bg-white p-4 sm:p-5">
        <div className="flex items-center gap-4 sm:gap-5">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-sm text-[#6B6A72] mt-0.5 hidden sm:block">
        ...
        <div className="flex items-center gap-4 mt-3 sm:hidden">
          ...
          <div className={`ml-auto px-2 py-1 rounded text-[11px] font-semibold ${zone.bg} ${zone.color} ${zone.border} border`}>
            {zone.label}
          </div>
        </div>
      </div>
