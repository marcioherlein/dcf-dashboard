  ...
  if (!entries.length) {
    return (
      <div className="flex flex-col items-center justify-center py-20 text-center">
        <div className="w-16 h-16 rounded-full bg-[#EEF4FF] border border-[#DCE6F5] flex items-center justify-center mb-4">
          <svg width="24" height="24" viewBox="0 0 16 16" fill="#1f6feb">
        ...
        <p className="text-[#2D2C31] font-semibold text-sm mb-1">No stocks analysed yet</p>
