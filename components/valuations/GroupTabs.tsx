    ...
    <div className="overflow-x-auto -webkit-overflow-scrolling-touch pb-1">
      ...
      <button
        ...
        className={cn(
          ...
          active === null
            ...
            : 'bg-white border border-[#E3E1DA] text-[#566174] hover:bg-[#F0F1F6]',
        )}
      >
        All
        <span
      ...
      {adding ? (
        ...
        <button
          ...
          className="flex items-center gap-1 px-2.5 py-1.5 rounded-lg text-[13px] font-medium text-[#8A95A6] hover:text-[#566174] hover:bg-[#F0F1F6] border border-dashed border-[#CDD1C8] transition-colors"
        >
