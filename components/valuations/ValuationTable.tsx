        ...
        <table className="w-full">
          <thead>
            <tr className="border-b border-slate-200 bg-slate-50/80">
              ...
              <th className="px-3 py-2.5 text-[11px] font-semibold text-slate-400 uppercase tracking-wide text-center whitespace-nowrap">
                1M
              </th>
                  ...
                  <td className="px-3 py-3 min-w-[160px]">
                    <div className="flex items-center gap-2.5">
                      ...
                      <div className="min-w-0">
                        ...
                        <div className="text-[11px] text-slate-400 mt-0.5 truncate max-w-[130px]">{entry.companyName}</div>
                      </div>
                    </div>
                  </td>
