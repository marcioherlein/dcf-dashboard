        ...
        <div className="space-y-2">
          {news.map((item, i) => (
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="group block rounded-xl border border-slate-100 bg-white p-4 hover:border-blue-200 hover:shadow-sm transition-all"
            >
              <p className="text-[13px] font-medium leading-snug text-slate-800 group-hover:text-blue-700 transition-colors mb-2.5 line-clamp-2">
                {item.title}
              </p>
