...
export default function YahooFinancials({ statementsData, currency = '$', reportingCurrency, highlight }: Props) {
  ...
  return (
    <div className="overflow-hidden">
      ...
      {sparseHistory && (
        <div className="px-4 pt-2 flex items-center gap-1.5 text-[11px] text-[#B56A00]">
      ...
      <div className="px-4 pt-2 pb-1 text-[11px] text-[#8A95A6] flex items-center gap-3">
        ...
        {ttmMissing && (
          <span className="text-[#8A95A6] italic">TTM not available for this statement</span>
        )}
      </div>
                ...
                (
                  ...
                  >
                    <td className="sticky left-0 z-10 bg-[#F4F3EF] px-3 sm:px-4 py-2 font-semibold text-[#06101F] whitespace-nowrap flex items-center gap-1.5">
                      ...
                      <span className={isOrphan ? 'text-[11px] font-medium text-[#8A95A6] uppercase tracking-wider' : ''}>
                        {hdr.label}
                      </span>
                    </td>
                    {showTTM && ttmData && (
      ...
      <div className="px-4 py-2 text-[10px] text-[#8A95A6]">
