...
export default function FinancialScores({ scores }: Props) {
  ...
  const altmanColor = altmanSafe == null ? 'text-gray-400 dark:text-white/30'
    : altmanGood ? 'text-emerald-600 dark:text-emerald-400'
    : altmanMid  ? 'text-amber-600 dark:text-amber-400'
    : 'text-red-600 dark:text-red-400'
  const altmanBg = altmanSafe == null ? 'bg-gray-50 border-gray-200 dark:bg-white/5 dark:border-white/10'
    : altmanGood ? 'bg-emerald-50 border-emerald-200 dark:bg-emerald-500/10 dark:border-emerald-500/20'
    : altmanMid  ? 'bg-amber-50 border-amber-200 dark:bg-amber-500/10 dark:border-amber-500/20'
    : 'bg-red-50 border-red-200 dark:bg-red-500/10 dark:border-red-500/20'
  const altmanBadge = altmanSafe == null ? 'bg-gray-100 text-gray-500 dark:bg-white/10 dark:text-white/40'
    : altmanGood ? 'bg-emerald-100 text-emerald-700 dark:bg-emerald-500/20 dark:text-emerald-400'
    : altmanMid  ? 'bg-amber-100 text-amber-700 dark:bg-amber-500/20 dark:text-amber-400'
          ...
          <div className="mb-3 flex items-start justify-between">
            <div>
              ...
              {altmanSafe != null ? (
                ...
                <p className="mt-0.5 text-sm text-gray-400 dark:text-white/30">Insufficient data</p>
              )}
            </div>
