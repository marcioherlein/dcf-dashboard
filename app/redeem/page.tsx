...
export default function RedeemPage() {
  ...
  return (
    <div className="min-h-dvh bg-[#F0F1F6] flex items-center justify-center px-4 py-16">
          ...
          <div className="bg-white rounded-2xl border border-[#E3E1DA] shadow-sm px-6 py-8 space-y-5">
            ...
            <div className="space-y-3">
              <input
                ...
                className="w-full rounded-xl border border-[#E3E1DA] bg-[#F0F1F6] px-4 py-3 text-[16px] font-mono font-semibold text-[#06101F] placeholder-slate-400 focus:outline-none focus:border-blue-400 focus:ring-2 focus:ring-olive-100 transition-all uppercase tracking-wider"
              />
