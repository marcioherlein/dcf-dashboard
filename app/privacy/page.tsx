...
export const metadata = { title: 'Privacy Policy — Rationale' }
      ...
      <div className="mx-auto max-w-3xl px-6 py-16 sm:py-24">
        ...
        <div className="prose prose-slate max-w-none space-y-8 text-sm text-slate-600 leading-relaxed">
          ...
          <section>
            ...
            <p>
              Rationale (&quot;we&quot;, &quot;us&quot;) is committed to protecting your privacy. This policy
          ...
          <section>
            ...
            <p>We use the following services to operate Rationale. Each has its own privacy policy.</p>
