...
export function buildBusinessSummary(companyName: string, data: FinancialsData, answers: AllAnswers): string {
...
export function buildManagementSummary(companyName: string, data: FinancialsData, answers: AllAnswers): string {
...
export function buildRiskSummary(companyName: string, data: FinancialsData, answers: AllAnswers): string {
...
export function buildValuationSummary(companyName: string, data: FinancialsData, answers: AllAnswers): string {
  const d = data as any
